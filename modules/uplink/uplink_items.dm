...
/datum/uplink_item/support/gygax
	...
	cost = 80
	surplus 10 // How does it fit in a crate i do not know..
...
/datum/uplink_item/device_tools/telecrystal/twenty
	...
	cost = 20
	surplus = 40 //cargo will be pleased if they are lucky.
...
/datum/uplink_item/role_restricted/pie_cannon
	...
	item = /obj/item/pneumatic_cannon/pie/selfcharge
	restricted_roles = list("Clown")
	surplus = 45 //HONK! incase the fun police take your pie cannon away
