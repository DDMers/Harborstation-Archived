...
/mob/proc/kiss(mob/partner)
	if (src.lust >= 3)
		to_chat(src, "<span class='warning'>You gave an intense, lingering kiss to \the [partner].</span>")
		visible_message("<span class='warning'>\The [src] gives an intense, lingering kiss to \the [partner].</span>")
	else
		to_chat(src, "<span class='warning'>You kissed \the [partner] deeply.</span>")
		visible_message("<span class='warning'>\The [src] kisses \the [partner] deeply.</span>")
